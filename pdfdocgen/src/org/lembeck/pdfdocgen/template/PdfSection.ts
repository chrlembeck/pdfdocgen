...
export class PdfSection {
  ...
  private _fixedContentAreas: Map<string, ContentArea> = new Map<string, ContentArea>();

  private _graphicElements: LayoutedElement[] = [];
  ...
  addGraphicElement(element: LayoutedElement): void {
    this._graphicElements.push(element);
  }

  get graphicElements(): LayoutedElement[] {
    return this._graphicElements;
  }
}